...
void KDtree::Create(vector <Point_3> &pts, int max_levels)
{
    m_pts = &pts;
    m_levels = max_levels;
...
{
    vector <Point_3> &pts = *myself->m_pts;
...
void KDtree::SearchAtNode(KDNode *cur, const Point_3 &query, int *ret_index, float *ret_dist, KDNode **ret_node)
{
    int best_idx = 0;
...
void KDtree::SearchAtNodeRange(KDNode *cur, const Point_3 &query, float range, int *ret_index, float *ret_dist)
{
    int best_idx = 0;
    float best_dist = FLT_MAX;
    vector <Point_3> &pts = *m_pts;
...
void KDtree::Search(const Point_3 &query, int *ret_index, float *ret_dist)
{
